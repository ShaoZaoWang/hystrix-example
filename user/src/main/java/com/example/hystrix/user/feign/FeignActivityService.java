...
public class FeignActivityService {
    ...
    public String firstLogin(Long userId) {
        return restTemplate.postForObject("http://activity/feign/firstLoginActivity", userId, String.class);
    }
    ...
    public String firstLoginTimeout(Long userId) {
        return restTemplate.postForObject("http://activity/feign/firstLoginActivityTimeout", userId, String.class);
    }
    ...
    public String firstLoginFallback(Long userId) {
        return restTemplate.postForObject("http://activity/feign/firstLoginActivityError", userId, String.class);
    }
